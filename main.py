...
array_http = config_sort(array_http)
array_grpc = config_sort(array_grpc)
...
raw_matches_http = config_sort(raw_matches_http)
raw_matches_grpc = config_sort(raw_matches_grpc)
...
array_http_channels = config_sort(array_http_channels)
array_grpc_channels = config_sort(array_grpc_channels)
